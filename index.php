	...
	<body>
		<div class="page">
			...
			<div class="body">
				<div id="featured">
					<h3>Hello</h3>
					<p>I am a fourth year Electronic Engineering student at the University of Southampton. I began my interest in electronics at GCSE level, building simple circuits and testing them. This inspired me to take it to a higher level at University along with some hobbyist electronics along the way. A large proportion of my interest is now in Embedded Systems, automation, robotics and computers. </p>
					<p>&nbsp;</p>
					<p>This website is a summary of my projects, achievements and a collection of usefull links and some photos. Feel free to browse the site and contact me if you have any quiries. My Curriculum Vitae is also availiable <a href="./Documents/HenryLovett_CV.pdf">here.</a></p>
                    <?php
                    echo "PHP!";
                    ?>
				</div>
